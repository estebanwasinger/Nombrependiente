...
class TestGenerarEquipos {
	...
	def void init() {
		...
		sytek = new Jugador("sytek", 6d, new ArrayList (5d, 8d))
		chicho = new Jugador("chicho", 7d, new ArrayList(6d, 8d, 6d))
		pato = new Jugador("pato", 8d, new ArrayList(9d, 8d))
		lechu = new Jugador("lechu", 7d, new ArrayList(7d, 9d))
		rodri = new Jugador("rodri", 6d, new ArrayList(5d, 8d))
		mike = new Jugador("mike", 5d, new ArrayList(4d, 10d, 6d, 8d))
		dodi = new Jugador("dodi", 7d, new ArrayList(6d, 7d))
		roly = new Jugador("roly", 8d, new ArrayList(6d, 6d, 9d))
		eric = new Jugador("eric", 6d, new ArrayList(9d, 4d, 3d, 10d))
		eric.modoSolidario
		leo = new Jugador("leo", 5d, new ArrayList(6d, 6d, 6d))
		leo.modoSolidario
		ferme = new Jugador("ferme", 8d, new ArrayList(9d, 10d, 7d))
		ferme.modoSolidario
	...
	def void generarEquiposPorHandicap() {
		...
		Assert.assertArrayEquals(new ArrayList(ferme, roly, pato, dodi, lechu, chicho, rodri, sytek, leo, mike),
	...
	def void generarEquiposPorCalificacionUltimos2Partidos() {
		...
		Assert.assertArrayEquals(new ArrayList(ferme, pato, lechu, roly, mike, chicho, dodi, rodri, sytek, leo),
			partido1.ordenarEquipos)
	}
